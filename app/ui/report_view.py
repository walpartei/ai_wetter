...
class ReportView:
        ...
        try:
            ...
            <div class="card mb-4">
                <div class="card-header bg-primary text-white">
                    <h4>Weather Report for {location_name}</h4>
                    <p class="mb-0">Generated on {date_str}, {days} day forecast</p>
                </div>
                <div class="card-body">
            '''
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="card">
                                <div class="card-body text-center">
                                    <h5 class="card-title">{period_display}</h5>
                                    <div class="display-4 text-{confidence_class}">{int(level * 100)}%</div>
                                </div>
                            </div>
                        </div>
                        '''
            ...
            if charts:
                ...
                if "temperature" in charts and charts["temperature"]:
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body text-center">
                            <img src="data:image/png;base64,{charts['temperature']}" class="img-fluid" alt="Temperature Chart">
                        </div>
                    </div>
                    '''
                ...
                if "precipitation" in charts and charts["precipitation"]:
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5>Precipitation and Humidity Forecast</h5>
                        </div>
                        <div class="card-body text-center">
                            <img src="data:image/png;base64,{charts['precipitation']}" class="img-fluid" alt="Precipitation Chart">
                        </div>
                    </div>
                    '''
                ...
                if "wind" in charts and charts["wind"]:
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body text-center">
                            <img src="data:image/png;base64,{charts['wind']}" class="img-fluid" alt="Wind Chart">
                        </div>
                    </div>
                    '''
                ...
                if "confidence" in charts and charts["confidence"]:
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body text-center">
                            <img src="data:image/png;base64,{charts['confidence']}" class="img-fluid" alt="Confidence Chart">
                        </div>
                    </div>
                    '''
                ...
                for chart_key, chart_title in comparison_charts:
                    if chart_key in charts and charts[chart_key]:
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body text-center">
                                <img src="data:image/png;base64,{charts[chart_key]}" class="img-fluid" alt="{chart_title}">
                            </div>
                        </div>
                        '''
            ...
            if accuracy and "sources" in accuracy:
                ...
                for source, metrics in accuracy["sources"].items():
                    ...
                    <tr>
                        ...
                        <td>{int(metrics.get("temperature", 0) * 100)}%</td>
                        <td>{int(metrics.get("precipitation", 0) * 100)}%</td>
                        <td>{int(metrics.get("wind", 0) * 100)}%</td>
                        <td><strong>{int(metrics.get("overall", 0) * 100)}%</strong></td>
                    </tr>
                    '''
    ...
    def render_report_list(reports: list, location: Location) -> str:
        ...
        html = f'''
        <h4>Saved Reports for {location.name}</h4>
        ...
        for report in reports:
            try:
                ...
                html += f'''
                <a href="/report/view/{location.id}/{date_str}" class="list-group-item list-group-item-action">
                    <div class="d-flex w-100 justify-content-between">
                        <h5 class="mb-1">Report from {date_str}</h5>
                    </div>
                    <p class="mb-1">{days} day forecast</p>
                </a>
                '''
